...
A character draw wheel tool designed for the **BOMBANANA!** game. Three monkeys, one bomb, teamwork for survival!
...
<img src="wheel-main.jpg" alt="Wheel Main Interface" width="50%">

### Spin Result
<img src="wheel-result.jpg" alt="Spin Result" width="50%">
...
### V1.0 (2026-07-01)
- Initial release
- Basic wheel spin functionality
- Chinese / English language switch support
- Canvas-based wheel rendering with CSS3 animations
